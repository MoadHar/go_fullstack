...
(
	...
	CONSTRAINT	FK_106  FOREIGN KEY ( Exercise_ID ) REFERENCES gowebapp.Exercises 
	( Exercise_ID ) 
);
...
(
	...
	CONSTRAINT PK_workouts PRIMARY KEY ( Workout_ID, Set_ID, Exercise_ID ),
	CONSTRAINT FK_71 FOREIGN KEY ( Set_ID, Exercise_ID) REFERENCES gowebapp.sets
	( Set_ID, Exercise_ID ),
